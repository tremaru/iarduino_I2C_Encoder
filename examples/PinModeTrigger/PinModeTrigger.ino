// ПРИМЕР НАСТРОЙКИ ВЫХОДА В РЕЖИМ ПЕРЕКЛЮЧАТЕЛЯ: //   Режимы работы выхода модуля энергонезависимы (сохраняются и после отключения питания).
...
void setup(){                                     //
    ...
    enc.setPinOut(ENC_PIN_MODE_TRG);              //   Указываем выводу модуля работать как кнопочный переключатель (триггер).
}                                                 //
                                                  //
void loop(){}                                     //